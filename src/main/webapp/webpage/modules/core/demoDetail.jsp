...
<head>
	<title>机构管理</title>
	<!--### -->
	<script src="${ctxJavaScript}/core/demoDetial.js"></script>
</head>
<body>
			   ...
			   <tbody id="dataBox">
			      ...
			      <tr>
			         <td class="width-15 "><label>工作:</label></td>
			          <td class="width-35"><input type="text" id="jobs" value="${data.jobs }"></td>
			         <td  class="width-15"><label>住址:</label></td>
			          <td class="width-35"><input type="text" id="address" value="${data.address }"></td>
			      </tr>
			      <tr>
