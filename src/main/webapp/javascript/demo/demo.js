$(document).ready(function(){
				var ctx = $("#ctx").val();
				var urlGetData = ctx + '/demo/data';
				var urlAdd = ctx + '/demo/add';
				var urlDel = ctx + '/demo/del';
				...
				$('#showModal').on('hidden.bs.modal', function () {
					mmg.load();
                	 ...
                	 var cols = [
                                 ...
                                 { title:'职位', name:'jobs' ,width:100, sortable: true, align:'center'  },
                                 { title:'住址', name:'address' ,width:100, sortable: true, align:'center'  }
                             ];
